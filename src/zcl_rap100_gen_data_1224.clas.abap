CLASS zcl_rap100_gen_data_1224 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_1224 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '1224',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrv1224.
    DELETE FROM zrap100_dtrv1224.

    "insert travel demo data
    INSERT zrap100_atrv1224  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ATRV{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
